...
function TargetingTable(props) {
  ...
  const fetchData = async () => {
    ...
    if (props.selectedProfiles === "SP") {
      apiEndPoint = `https://finnapi.sellingpartnerservice.com/Ads/SPCampaignManager/${props.tabName}`;
    } else if (props.selectedProfiles === "SB") {
      apiEndPoint = `https://finnapi.sellingpartnerservice.com/Ads/SBCampaignManager/${props.tabName}`;
    } else if (props.selectedProfiles === "SD") {
      apiEndPoint = `https://finnapi.sellingpartnerservice.com/Ads/SDCampaignManager/${props.tabName}`;
    }
    ...
    try {
      ...
      // ✅ Always rebuild columns freshly
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      switch (props.selectedProfiles) {
        case "SP":
          apiEndPoint = `https://finnapi.sellingpartnerservice.com/Ads/SPCampaignManager/${props.tabName}/Export`;
          break;
        case "SB":
          apiEndPoint = `https://finnapi.sellingpartnerservice.com/Ads/SBCampaignManager/${props.tabName}/Export`;
          break;
        case "SD":
          apiEndPoint = `https://finnapi.sellingpartnerservice.com/Ads/SDCampaignManager/${props.tabName}/Export`;
          break;
      }
      ...
      a.download = `${storedLabel}${country}_${profileDescription}_${
        props.tabName
      }_${advancedFilterDateRange.startDate?.slice(0, 10)}-${advancedFilterDateRange.endDate?.slice(
        0,
        10
      )}.csv`;
